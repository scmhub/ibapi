...
type EWrapper interface {
	...
	// UpdateAccountValueProtoBuf .
	UpdateAccountValueProtoBuf(accountValueProto *protobuf.AccountValue)
	// UpdatePortfolioProtoBuf .
	UpdatePortfolioProtoBuf(portfolioValueProto *protobuf.PortfolioValue)
	// UpdateAccountTimeProtoBuf .
	UpdateAccountTimeProtoBuf(accountUpdateTimeProto *protobuf.AccountUpdateTime)
	// AccountDataEndProtoBuf .
	AccountDataEndProtoBuf(accountDataEndProto *protobuf.AccountDataEnd)
	// ManagedAccountsProtoBuf .
	ManagedAccountsProtoBuf(managedAccountsProto *protobuf.ManagedAccounts)
	// PositionProtoBuf .
	PositionProtoBuf(positionProto *protobuf.Position)
	// PositionEndProtoBuf .
	PositionEndProtoBuf(positionEndProto *protobuf.PositionEnd)
	// AccountSummaryProtoBuf .
	AccountSummaryProtoBuf(accountSummaryProto *protobuf.AccountSummary)
	// AccountSummaryEndProtoBuf .
	AccountSummaryEndProtoBuf(accountSummaryEndProto *protobuf.AccountSummaryEnd)
	// PositionMultiProtoBuf .
	PositionMultiProtoBuf(positionMultiProto *protobuf.PositionMulti)
	// PositionMultiEndProtoBuf .
	PositionMultiEndProtoBuf(positionMultiEndProto *protobuf.PositionMultiEnd)
	...
	// SecDefOptParameterProtoBuf .
	SecDefOptParameterProtoBuf(secDefOptParameterProto *protobuf.SecDefOptParameter)
	// SecDefOptParameterEndProtoBuf .
	SecDefOptParameterEndProtoBuf(secDefOptParameterEndProto *protobuf.SecDefOptParameterEnd)
	// SoftDollarTiersProtoBuf .
	SoftDollarTiersProtoBuf(softDollarTiersProto *protobuf.SoftDollarTiers)
	// FamilyCodesProtoBuf .
	FamilyCodesProtoBuf(familyCodesProto *protobuf.FamilyCodes)
	// SymbolSamplesProtoBuf .
	SymbolSamplesProtoBuf(symbolSamplesProto *protobuf.SymbolSamples)
	// SmartComponentsProtoBuf .
	SmartComponentsProtoBuf(smartComponentsProto *protobuf.SmartComponents)
	// MarketRuleProtoBuf .
	MarketRuleProtoBuf(marketRuleProto *protobuf.MarketRule)
	// UserInfoProtoBuf .
	UserInfoProtoBuf(userInfoProto *protobuf.UserInfo)
	// NextValidIdProtoBuf .
	NextValidIdProtoBuf(nextValidIdProto *protobuf.NextValidId)
	// CurrentTimeProtoBuf .
	CurrentTimeProtoBuf(currentTimeProto *protobuf.CurrentTime)
	// CurrentTimeInMillisProtoBuf .
	CurrentTimeInMillisProtoBuf(currentTimeInMillisProto *protobuf.CurrentTimeInMillis)
	// VerifyMessageApiProtoBuf .
	VerifyMessageApiProtoBuf(verifyMessageApiProto *protobuf.VerifyMessageApi)
	// VerifyCompletedProtoBuf .
	VerifyCompletedProtoBuf(verifyCompletedProto *protobuf.VerifyCompleted)
	// DisplayGroupListProtoBuf .
	DisplayGroupListProtoBuf(displayGroupListProto *protobuf.DisplayGroupList)
	// DisplayGroupUpdatedProtoBuf .
...
func (w Wrapper) OpenOrder(orderID int64, contract *Contract, order *Order, orderState *OrderState) {
	logger := log.Info().Str("PermID", LongMaxString(order.PermID)).Str("ClientID", IntMaxString(order.ClientID)).Str("int64", IntMaxString(order.OrderID))
...
func (w Wrapper) SecDefOptParameterProtoBuf(secDefOptParameterProto *protobuf.SecDefOptParameter) {
	log.Debug().Stringer("secDefOptParameterProto", secDefOptParameterProto).Msg("<SecDefOptParameterProtoBuf>")
}

func (w Wrapper) SecDefOptParameterEndProtoBuf(secDefOptParameterEndProto *protobuf.SecDefOptParameterEnd) {
	log.Debug().Stringer("secDefOptParameterEndProto", secDefOptParameterEndProto).Msg("<SecDefOptParameterEndProtoBuf>")
}

func (w Wrapper) SoftDollarTiersProtoBuf(softDollarTiersProto *protobuf.SoftDollarTiers) {
	log.Debug().Stringer("softDollarTiersProto", softDollarTiersProto).Msg("<SoftDollarTiersProtoBuf>")
}

func (w Wrapper) FamilyCodesProtoBuf(familyCodesProto *protobuf.FamilyCodes) {
	log.Debug().Stringer("familyCodesProto", familyCodesProto).Msg("<FamilyCodesProtoBuf>")
}

func (w Wrapper) SymbolSamplesProtoBuf(symbolSamplesProto *protobuf.SymbolSamples) {
	log.Debug().Stringer("symbolSamplesProto", symbolSamplesProto).Msg("<SymbolSamplesProtoBuf>")
}

func (w Wrapper) SmartComponentsProtoBuf(smartComponentsProto *protobuf.SmartComponents) {
	log.Debug().Stringer("smartComponentsProto", smartComponentsProto).Msg("<SmartComponentsProtoBuf>")
}

func (w Wrapper) MarketRuleProtoBuf(marketRuleProto *protobuf.MarketRule) {
	log.Debug().Stringer("marketRuleProto", marketRuleProto).Msg("<MarketRuleProtoBuf>")
}

func (w Wrapper) UserInfoProtoBuf(userInfoProto *protobuf.UserInfo) {
	log.Debug().Stringer("userInfoProto", userInfoProto).Msg("<UserInfoProtoBuf>")
}

func (w Wrapper) NextValidIdProtoBuf(nextValidIdProto *protobuf.NextValidId) {
	log.Debug().Stringer("nextValidIdProto", nextValidIdProto).Msg("<NextValidIdProtoBuf>")
}

func (w Wrapper) CurrentTimeProtoBuf(currentTimeProto *protobuf.CurrentTime) {
	log.Debug().Stringer("currentTimeProto", currentTimeProto).Msg("<CurrentTimeProtoBuf>")
}

func (w Wrapper) CurrentTimeInMillisProtoBuf(currentTimeInMillisProto *protobuf.CurrentTimeInMillis) {
	log.Debug().Stringer("currentTimeInMillisProto", currentTimeInMillisProto).Msg("<CurrentTimeInMillisProtoBuf>")
}

func (w Wrapper) VerifyMessageApiProtoBuf(verifyMessageApiProto *protobuf.VerifyMessageApi) {
	log.Debug().Stringer("verifyMessageApiProto", verifyMessageApiProto).Msg("<VerifyMessageApiProtoBuf>")
}

func (w Wrapper) VerifyCompletedProtoBuf(verifyCompletedProto *protobuf.VerifyCompleted) {
	log.Debug().Stringer("verifyCompletedProto", verifyCompletedProto).Msg("<VerifyCompletedProtoBuf>")
}

func (w Wrapper) DisplayGroupListProtoBuf(displayGroupListProto *protobuf.DisplayGroupList) {
	log.Debug().Stringer("displayGroupListProto", displayGroupListProto).Msg("<DisplayGroupListProtoBuf>")
}

func (w Wrapper) DisplayGroupUpdatedProtoBuf(displayGroupUpdatedProto *protobuf.DisplayGroupUpdated) {
