...
type Order struct {
	...
	ConditionsIncludeOvernight *bool  `protobuf:"varint,145,opt,name=conditionsIncludeOvernight,proto3,oneof" json:"conditionsIncludeOvernight,omitempty"`
...
func (x *Order) GetSeekPriceImprovement() int32 {
...
func (x *Order) GetConditionsIncludeOvernight() bool {
	if x != nil && x.ConditionsIncludeOvernight != nil {
		return *x.ConditionsIncludeOvernight
	}
	return false
}
...
const file_Order_proto_rawDesc = "" +
	"\n" +
	"\vOrder.proto\x12\bprotobuf\x1a\x14OrderCondition.proto\x1a\x14SoftDollarTier.proto\"\xcfL\n" +
	"\x05Order\x12\x1f\n" +
	...
	"\fhedgeMaxSize\x18\x90\x01 \x01(\x05H\x8b\x01R\fhedgeMaxSize\x88\x01\x01\x12E\n" +
	"\x1aconditionsIncludeOvernight\x18\x91\x01 \x01(\bH\x8c\x01R\x1aconditionsIncludeOvernight\x88\x01\x01\x1a=\n" +
	...
	"\v_whatIfTypeB\x0f\n" +
	"\r_hedgeMaxSizeB\x1d\n" +
	"\x1b_conditionsIncludeOvernightB\fZ\n" +
	".;protobufb\x06proto3"
