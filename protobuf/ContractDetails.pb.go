...
type ContractDetails struct {
	...
	SettlementMethod          *string `protobuf:"bytes,65,opt,name=settlementMethod,proto3,oneof" json:"settlementMethod,omitempty"`
...
func (x *ContractDetails) GetSettlementMethod() string {
...
const file_ContractDetails_proto_rawDesc = "" +
	"\n" +
	"\x15ContractDetails.proto\x12\bprotobuf\x1a\x19IneligibilityReason.proto\"\xb5 \n" +
	...
	"\x11lastSizePrecision\x18@ \x01(\tH=R\x11lastSizePrecision\x88\x01\x01\x12/\n" +
	"\x10settlementMethod\x18A \x01(\tH>R\x10settlementMethod\x88\x01\x01\x1a<\n" +
	...
	"\x12_lastSizePrecisionB\x13\n" +
	"\x11_settlementMethodB\fZ\n" +
	".;protobufb\x06proto3"
